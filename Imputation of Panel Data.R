...
unbalanced_panel_data_mcar_30[mis_simulated_mcar_30, 3] <- NA
...
unbalanced_panel_data_mcar_10[mis_simulated_mcar_10, 3] <- NA
...
# Model missingness via linear regression model
# Depending on x1, x2, and random error
mis_simulated_mar_50 <- 0.5 + 2 * unbalanced_panel_data_mar_50$x1 - 
  0.7 * unbalanced_panel_data_mar_50$x2 + 
...
# Set values to NA in y where missingness occurs
unbalanced_panel_data_mar_50$y[mis_simulated_mar_50] <- NA
...
# Model missingness via linear regression model
# Depending on x1, x2, and random error
mis_simulated_mar_30 <- 0.5 + 2 * unbalanced_panel_data_mar_30$x1 - 
  0.7 * unbalanced_panel_data_mar_30$x2 + 
...
# Set values to NA in y where missingness occurs
unbalanced_panel_data_mar_30$y[mis_simulated_mar_30] <- NA
...
# Model missingness via linear regression model
# Depending on x1, x2, and random error
mis_simulated_mar_10 <- 0.5 + 2 * unbalanced_panel_data_mar_10$x1 - 
  0.7 * unbalanced_panel_data_mar_10$x2 + 
...
# Set values to NA in y where missingness occurs
unbalanced_panel_data_mar_10$y[mis_simulated_mar_10] <- NA
...
# model missingness by logistic regression (probit):
# the missing of a value now also depends on counts itself
mis_simulated_mnar_50 <-0.5 + 1 * unbalanced_panel_data_mnar_50$x1 - 
  0.7 * unbalanced_panel_data_mnar_50$x2 - 
  5 * unbalanced_panel_data_mnar_50$y + rnorm(nrow(unbalanced_panel_data), 0, 3)
mis_simulated_mnar_50 <- mis_simulated_mnar_50 < quantile(mis_simulated_mnar_50, p_mis_50)
unbalanced_panel_data_mnar_50$y[mis_simulated_mnar_50] <- NA
...
# model missingness by logistic regression (probit):
# the missing of a value now also depends on counts itself
mis_simulated_mnar_30 <-0.5 + 1 * unbalanced_panel_data_mnar_30$x1 - 
  0.7 * unbalanced_panel_data_mnar_30$x2 - 
  5 * unbalanced_panel_data_mnar_30$y + rnorm(nrow(unbalanced_panel_data), 0, 3)
mis_simulated_mnar_30 <- mis_simulated_mnar_30 < quantile(mis_simulated_mnar_30, p_mis_30)
unbalanced_panel_data_mnar_30$y[mis_simulated_mnar_30] <- NA
...
# model missingness by logistic regression (probit):
# the missing of a value now also depends on counts itself
mis_simulated_mnar_10 <-0.5 + 1 * unbalanced_panel_data_mnar_10$x1 - 
  0.7 * unbalanced_panel_data_mnar_10$x2 - 
  5 * unbalanced_panel_data_mnar_10$y + rnorm(nrow(unbalanced_panel_data), 0, 3)
mis_simulated_mnar_10 <- mis_simulated_mnar_10 < quantile(mis_simulated_mnar_10, p_mis_10)
unbalanced_panel_data_mnar_10$y[mis_simulated_mnar_10] <- NA
